            ...
            <div class="row mb-n6">
                ...
                <div class="col-lg-6 col-12 mb-6">
                    ...
                    <div class="banner-single-item banner-style-1 banner-animation img-responsive" data-aos="fade-up"  data-aos-delay="0">
                        <div class="image">
                            <img src="{$urls.theme_assets}images/banner/banner-style-1-img-1.jpg" alt="">
                        </div>
                        <div class="content">
                    ...
                    <div class="row mb-n6">
                        ...
                        <div class="col-lg-6 col-sm-6 mb-6">
                            <div class="banner-single-item banner-style-2 banner-animation img-responsive" data-aos="fade-up"  data-aos-delay="0">
                                <div class="image">
                                    <img src="{$urls.theme_assets}images/banner/banner-style-2-img-1.jpg" alt="">
                                </div>
                                <div class="content">
                        ...
                        <div class="col-lg-6 col-sm-6 mb-6">
                            <div class="banner-single-item banner-style-2 banner-animation img-responsive" data-aos="fade-up"  data-aos-delay="200">
                                <div class="image">
                                    <img src="{$urls.theme_assets}images/banner/banner-style-2-img-2.jpg" alt="">
                                </div>
                                <div class="content">
                        ...
                        <div class="col-lg-6 col-sm-6 mb-6">
                            <div class="banner-single-item banner-style-2 banner-animation img-responsive" data-aos="fade-up"  data-aos-delay="0">
                                <div class="image">
                                    <img src="{$urls.theme_assets}images/banner/banner-style-2-img-3.jpg" alt="">
                                </div>
                                <div class="content">
                        ...
                        <div class="col-lg-6 col-sm-6 mb-6">
                            <div class="banner-single-item banner-style-2 banner-animation img-responsive" data-aos="fade-up"  data-aos-delay="200">
                                <div class="image">
                                    <img src="{$urls.theme_assets}images/banner/banner-style-2-img-4.jpg" alt="">
                                </div>
                                <div class="content">
                                    <h4>Interior <br>
                                        lighting</h4>
